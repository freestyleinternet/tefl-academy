...
<body>
    ...
    <div class="wrapper">
        ...
        <ul class="mobilemenu displaymobile">
        	<li><a href="#" class="toggle"><img src="assets/images/trigger.svg" alt="TEFL Academy"/></a></li>
    ...
    <div class="wrapper">
        ...
        <div class="m-all tb2-tb4 db2-db4 box">
    ...
    <div class="pale-strip">
        <div class="wrapper">
            <div class="m1 t-all d-all testimonails">
                <div class=center>
                    <span id=prev></span>
                    <span id=next></span>
                </div>
                <div class="cycle-slideshow testimonials-slider" 
                    ...
                    <div class="slide">
                    	...
                    	<div class="t3-t4 text">
                            ...
                            <p>My name is Chara and I am a 24 year old TEFL Teacher in China. Prior to teaching I worked in education recruitment in London where I interviewed teachers.</p>
                            <p>I would always ask 'Why did you want to become a teacher?' and I would say 'I want a rewarding, fun &amp; challenging job!'</p>
