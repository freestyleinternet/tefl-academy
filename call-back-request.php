<?php include 'includes/header.php'; ?>
    ...
    <div class="wrapper">
      	...
      	<section class="m1 t-all d1-d3">
            ...
            <div class="news-intro autoheight fullmobile">
            	<h1>CALL BACK REQUEST</h1>
            	<p>Vestibulum sed mi commodo neque imperdiet rutrum. Nulla porttitor dapibus augue quis bibendum. Vestibulum sed mi commodo neque imperdiet rutrum. Nulla porttitor dapibus augue quis bibendum.</p>
            </div>
            
            <div class="leftbx">
                <form class="bookingstyle" action="#" method="post">
                    <div>
                        <label>Name</label>
                        <input type="text">
                    </div>
